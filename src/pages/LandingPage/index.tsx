      ...
      <main className="bg-gray3 w-full h-screen flex justify-center">
        <div className="w-4/5 h-full flex flex-col-reverse justify-evenly items-center lg:flex-row lg:justify-between lg:items-center">
          <div className="flex flex-col items-center lg:items-start gap-3">
            ...
            <button className="w-full lg:w-40 h-10 bg-gray2 text-text rounded-md font-semibold hover:bg-dark hover:text-gray1">
              Acessar
            </button>
          </div>
          <img
            ...
            className="w-[21.875rem] h-[21.875rem] rounded-[6.25rem] xl:w-[25rem] xl:h-[25rem] 2xl:w-[31.25rem] 2xl:h-[31.25rem]"
          />
        </div>
      </main>
    </div>
